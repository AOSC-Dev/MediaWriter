...
!define UPDATEURL "https://getAOSC.org" # "Product Updates" link
!define ABOUTURL "https://getAOSC.org" # "Publisher" link
...
!else
    ...
    !if "${CERTPASS}" != ""
        !system 'osslsigncode sign -pkcs12 "${CERTPATH}/authenticode.pfx" -readpass "${CERTPASS}" -h sha256 -n "AOSC Media Writer" -i https://getAOSC.org -t http://timestamp.comodoca.com/authenticode -in "../../build/wineprefix/drive_c/uninstall.unsigned.exe" -out "../../build/wineprefix/drive_c/uninstall.exe" ' = 0
    !else
